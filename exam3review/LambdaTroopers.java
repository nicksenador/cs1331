...
public class LambdaTroopers {
    ...
    public static void main(String[] args) {
        ...
        // spurbury.removeIf((Trooper t) -> Objects.isNull(t));
        ...
        superTroopers.removeIf((Object o) -> spurbury.contains(o));
        ...
        Comparator<Trooper> byMustacheThenName =
            ...
            Comparator.comparing((Trooper e) -> e.hasMustache())
            .thenComparing((Trooper t) -> {
                return t.getName();
            });
